...
def generate_content():
    try:
        ...
        3. تحذير صارم: لا تكتب أبداً جمل نصية مثل "اضغط هنا" أو روابط أو أقواس روابط يدوية داخل النص النهائي.
        4. عند نهاية المحتوى بالكامل، قم بإضافة السطر التالي والمنفصل تماماً كعلامة مشفرة لظهور زر التواصل:
        [SHOW_CONTACT_BUTTON]
        5. اجعل الرد وافياً، مفصلاً، ومبتكراً بالكامل ليقدم قيمة حقيقية تدفع العميل للاستفادة والربح منها.
        """
